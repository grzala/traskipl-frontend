export const mapIconDropsUrls = {
    ...
    "DANGER": process.env.PUBLIC_URL + '/maps_icons/drops/danger.png',
    "FUEL": process.env.PUBLIC_URL + '/maps_icons/drops/fuel.png',
...
export const mapIconCirclesUrls = {
    ...
    "DANGER": process.env.PUBLIC_URL + '/maps_icons/circles/danger.png',
